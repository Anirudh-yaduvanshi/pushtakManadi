  ...
  return (
    <div className="pt-40 pb-30 min-h-screen bg-gray-900 text-gray-200">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-4xl font-bold mb-10 text-center bg-gray-800 text-white p-4 rounded-lg shadow-md">
          Contact Us
        </h2>
        ...
        {/* Library Hours */}
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg mt-12 text-center">
          <h3 className="text-2xl font-semibold mb-4 text-white">
            Library Hours
          </h3>
